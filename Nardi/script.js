...
var startButton = {onScreen: false};
  ...
  function changeColor() {
    ...
    colorOptions.forEach(option => {
      if (option.classList.contains('selected')) {
        var gradient = option.style.background;
        document.querySelector('.screen').style.background = gradient;
      }
    });
    closeColorPicker();
  }
  ...
  document.getElementById("changeColorButton").addEventListener("click", openColorPicker);
 // Variable to hold selected color
let selectedColor = '';
...
function changeColor() {
  // Apply selected color to the backgammon canvas (myCanvas)
  let canvas = document.getElementById('myCanvas');
  let ctx = canvas.getContext('2d');

  // Assuming you want to fill the canvas with the selected color
...
function drawBoard(brd) {
  var boardBorderColor = "black";
  var boardInnerColor = "gray";
  var triangleColor1 = "black";
  var triangleColor2 = "white";
  var triangleBorderColor = "white";
  var blackCheckerColor = "black";
  var whiteCheckerColor = "lightgray";
  var cubeBodyColor = "black";
  var cubeNumberColor = "white";
  var buttonBackgroundColor = "brown";
  var buttonBorderColor = "#333";
  var buttonTextColor = "white";
  var blackDiceBodyColor = "black";
  var blackDiceDotColor = "#DDD";
  var whiteDiceBodyColor = "#DDD";
  var whiteDiceDotColor = "white";
  var w = brd.width;
  var h = w*3/4;
